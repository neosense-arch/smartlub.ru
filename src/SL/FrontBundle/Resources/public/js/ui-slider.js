...
function sliderWeight() {
    jQuery( "#slider-weight .slider" ).slider({
        ...
        slide: function( event, ui ) {
            jQuery( "#slider-weight .left input" ).val(ui.values[ 0 ]);
            jQuery( "#slider-weight .right input" ).val(ui.values[ 1 ]);
        }
    });
...
function sliderSize() {
    jQuery( "#slider-size .slider" ).slider({
        ...
        slide: function( event, ui ) {
            jQuery( "#slider-size .left input" ).val(ui.values[ 0 ]);
            jQuery( "#slider-size .right input" ).val(ui.values[ 1 ]);
        }
    });
    jQuery('.ui-slider-handle').last().addClass('last')
